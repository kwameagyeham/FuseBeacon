 ...
 * This file demonstrates how to integrate Fusebeacon with a web frontend
 */

// For React/Vue/Angular applications
export class FusebeaconClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new FusebeaconClient(provider, contractAddress);
